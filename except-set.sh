...
echo -e " © RECODE BY MY SELF EXCEPT STORE ${YELLOW}(${NC} 2020 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/"
...
TIMES="10"
CHATID="6334811917"
KEY="6283319202:AAEpHUxKaB-pvlU0wK2ClAfGADr_LwTnGDI"
URL="https://api.telegram.org/bot$KEY/sendMessage"
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/izin | grep $ipsaya | awk '{print $3}')
...
<code>──────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/except_x"},{"text":"INSTALL","url":"https://t.me/except_x"}]]}'
...
wget raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh

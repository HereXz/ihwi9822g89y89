...
```
apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/except-set.sh && chmod +x except-set.sh && ./except-set.sh
```
...
```
wget https://raw.githubusercontent.com/HereXz/ihwi9822g89y89/main/except-update.sh && chmod +x except-update.sh && ./except-update.sh
```
...
<img width="100%" alt="Screenshot_20231230_112617" src="https://s.id/24ast">
